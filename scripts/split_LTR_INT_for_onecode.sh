...
if [ $entries != $unique ]
then
    echo -e "\nWARNING: More than 1 possible output for at least one entry or one entry missing from output, please check output manually"
fi    

# parse blast 
echo "###gff-annotation" > LTR_annotation.gff
cat blast.$current_time | awk '{OFS="\t";if ( ($1==$2) &&  ($4<1000) && ($7<20) && ($9>1000) && ($10 >= ($13-10))) {print $1,"manual","LTR",1,$8,".","+",".","Superfamily \""$1 "\"; Family \""$1"\"; Type \"LTR\"; Subpart \"5LTR\";\n"$1,"manual","LTR",$8+1,$9-1,".","+",".","Superfamily \""$1 "\"; Family \""$1"\"; Type \"INT\"; Subpart \"INT\";\n"$1,"manual","LTR",$9,$10,".","+",".","Superfamily \""$1 "\"; Family \""$1"\"; Type \"LTR\"; Subpart \"3LTR\";"}}'>> LTR_annotation.gff
